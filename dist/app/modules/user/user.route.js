...
router.get("/getUserByEmail/:email", (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), user_controler_1.UserControllers.getUserByEmail);
router.patch("/block/:id", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), user_controler_1.UserControllers.blockUser);
router.patch("/toggle/:id", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), user_controler_1.UserControllers.toggleUserStatus);
